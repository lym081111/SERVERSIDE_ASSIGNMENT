    ...
    <div class="content dashboard-shell">
        ...
        <div class="page-header">
            <div>
                ...
                <p class="page-subtitle">Follow your co-curricular flow: Club -> Event -> Merit -> Achievement.</p>
            </div>
        ...
        <div class="module-grid">
            ...
            <div class="module-card club">
                ...
                <div style="margin-top:10px;">
                    <a href="index.php?url=club/timeline" class="link">View Club Involvement Timeline</a>
                </div>
            </div>
