                ...
                <div class="admin-section-body">
                    <form method="POST" class="form">
                        ...
                        <div class="form-grid" style="margin-top:14px;">
                            <div>
                                ...
                                <input
                                    ...
                                    value="<?= htmlspecialchars($_POST['clubName'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                                    required
                                >
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="<?= htmlspecialchars($_POST['role'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                                >
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="date"
                                    name="startDate"
                                    value="<?= htmlspecialchars($_POST['startDate'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                                    required
                                >
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="date"
                                    name="endDate"
                                    value="<?= htmlspecialchars($_POST['endDate'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                                >
                        ...
                        <div style="margin-top:14px;">
                            ...
                            ><?= htmlspecialchars($_POST['roleDescription'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
                        </div>
