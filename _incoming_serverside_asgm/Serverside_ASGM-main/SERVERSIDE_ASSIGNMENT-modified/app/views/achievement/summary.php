        ...
        <div class="content-inner">
            ...
            <div class="summary-grid">
                ...
                <div class="summary-card" style="text-align:center;">
                    ...
                    <?php
                        // Star milestones: reach 3 = 1★, reach 5 = 2★, reach 10 = 3★, reach 20 = 4★, exceed 20 = 5★
                        $starMilestones = [3, 5, 10, 20];
                        $earnedStars = 0;
                        foreach ($starMilestones as $goal) {
                            if ($totalAchievements >= $goal) $earnedStars++;
                        }
                        if ($totalAchievements > 20) $earnedStars = 5;
                        $totalStars = 5;
                    ...
                    <div class="summary-sub" style="margin-top:6px; color:#64748b; font-size:0.85rem;">
                        <?php if ($earnedStars < $totalStars): ?>
                            Next star at <?= htmlspecialchars($starLabels[$earnedStars + 1] ?? '', ENT_QUOTES, 'UTF-8') ?>
                        <?php else: ?>
