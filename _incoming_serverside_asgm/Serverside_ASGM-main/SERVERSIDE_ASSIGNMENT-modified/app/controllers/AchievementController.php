...
class AchievementController {
    ...
    public function delete() {
        ...
        // Preserve search/filter state so user stays on the same filtered page
        $filterSearch = isset($_POST['_filter_search']) ? urlencode(trim((string) $_POST['_filter_search'])) : '';
        $filterSort   = isset($_POST['_filter_sort'])   ? urlencode(trim((string) $_POST['_filter_sort']))   : '';
        $filterStatus = isset($_POST['_filter_status']) ? urlencode(trim((string) $_POST['_filter_status'])) : '';
